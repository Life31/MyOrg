    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='c_chs_numbers', to='configs.Number', verbose_name='Номер конфигурации')),
                ('unit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='c_chs_units', to='configs.Unit', verbose_name='Блок')),
            ],
            options={
