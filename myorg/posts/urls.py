...
urlpatterns = [
     ...
     path('new_one/<int:stend_id>/<int:start_id>/<str:day>/',
          views.post_new_one,
          name='post_new_one',),
     ...
     path('stend/<int:group_id>/', views.stend, name='stend'),
     path('stend_with_over/<int:group_id>/', views.stend_with_over, name='stend_with_over'),
     path('stend/<int:group_id>/<str:filtr>/', views.stend_filtr, name='stend_filtr'),
     path('stend_filtr_with_over/<int:group_id>/<str:filtr>/', views.stend_filtr_with_over, name='stend_filtr_with_over'),
     ...
     path('requests/rele_fib/', views.rele_fib, name='rele_fib'),
